...
export function IconEyeOff({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M3 3l18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M9.9 5.1A10.4 10.4 0 0 1 12 5c6.5 0 10 7 10 7a18.7 18.7 0 0 1-5 5.1M6.2 6.2C3.8 8.1 2 12 2 12s3.5 7 10 7a10 10 0 0 0 4.1-.9"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconPasskey({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M4 20v-1a5 5 0 0 1 5-5h0a5 5 0 0 1 5 5v1M15 11h4l2 2v3h-3"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
