          ...
          <>
            ...
            >
              <div className="hero-copy" data-tone="left">
                ...
                <p>
                  Convertimos tus activos en liquidez inmediata con la precisión
                  de nuestra inteligencia artificial. Sin trámites eternos, sin
                  complicaciones.
                </p>
                      ...
                      <li key={item.step}>
                        <article className="workflow-card">
                          <div className="card-head">
                            <img src={item.img_route} className="chip" />
              ...
              <section className="promo-section" aria-label="Valor y soporte">
                <div className="promo-section-inner">
                  <article className="promo-main">
                    ...
                    <p>
                      Nuestra tecnología de punta analiza el mercado global para
                      darte siempre el precio más justo por tus artículos
                      electrónicos.
                    </p>
                  ...
                  <aside className="promo-side">
                    ...
                    <article className="promo-help">
                      ...
                      <p>
                        Nuestros asesores están disponibles 24/7 para apoyarte.
                      </p>
